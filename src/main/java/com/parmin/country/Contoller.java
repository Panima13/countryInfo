...
public class Contoller {
	...
	List<MenuItem> menus = List.of(new MenuItem("Home", "/home"), new MenuItem("Search", "search"),
	...
	String country(@RequestParam(required = false) String searchtext, Model model) {
		...
		Map<String, Object> countryInfoAllData = objectMapper.readValue(response,
				new TypeReference<Map<String, Object>>() {
				});
		Map<String, Object> countryInfoData = (Map<String, Object>) countryInfoAllData.get("data");
		List<Map<String, Object>> countryInfoObjects = (List<Map<String, Object>>) countryInfoData.get("objects");

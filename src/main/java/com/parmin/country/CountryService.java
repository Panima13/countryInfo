...
public class CountryService {
	...
	public String getCountry(String countryName) throws IOException, InterruptedException {
		...
		HttpRequest request = HttpRequest.newBuilder()
				.uri(URI.create("https://api.restcountries.com/countries/v5/name?q=" + encodedCountry + "&limit=30"))
				.header("Authorization", "Bearer rc_live_db92af4688594896aba962c402f11b81").GET().build();
